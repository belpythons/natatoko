...
class DashboardService
{
     ...
     * OPTIMIZED: Minimized queries using conditional aggregation.
     */
    public function getBoxOrderStats(): array
    {
        ...
        // Use conditional aggregation to combine 5 queries into 1.
        // Bounded to avoid full table scan: we only need records from this month OR pending records.
        // Grouped logically to prevent bypassing Global Scopes.
